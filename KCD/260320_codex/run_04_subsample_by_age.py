...
Run from 26-1: ./.venv/bin/python 260320_codex/run_04_subsample_by_age.py
"""
...
# 월 단위 업력 상한 (이하만 포함)
# 2026-03-20 실행 기준으로 24개월 이하는 표본이 매우 작아 36/48/60개월 컷도 함께 저장한다.
SUBSAMPLE_MAX_MONTHS = [None, 60, 48, 36, 24, 12, 6]
