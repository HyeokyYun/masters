# 2026-03-20 개별연구 미팅 반영 (260320_cur)
...
```bash
# 프로젝트 루트에서
python 260320_cur/run_05_business_age_histogram.py   # 가벼움
python 260320_cur/run_01_trend_residual_cv.py      # 무거움 (weekly.parquet)
python 260320_cur/run_02_build_extended_dataset.py
python 260320_cur/run_03_extended_mnlogit.py
python 260320_cur/run_04_subsample_by_age.py
```

또는 `python 260320_cur/run_all.py`
