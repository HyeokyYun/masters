...
Run from 26-1: python 260320_cur/run_02_build_extended_dataset.py
"""
import re
...
from config import META_CSV, DF_MULTINOM, DF_MULTINOM_FALLBACK, OUT_DIR, LOG_DIR, TOP_DEPTH2_FOR_DUMMY
...
def main():
    ...
    if trend_path.exists():
        ...
        log("WARN: store_trend_residual.csv not found — run run_01 first")
