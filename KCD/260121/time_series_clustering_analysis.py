...
plt.tight_layout()
plt.savefig('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_img/cluster_timeseries.png', dpi=300, bbox_inches='tight')
print("클러스터별 시계열 그래프 저장: cluster_timeseries.png")
...
plt.tight_layout()
plt.savefig('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_img/cluster_distribution.png', dpi=300, bbox_inches='tight')
...
cluster_mapping.to_csv('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_csv/cluster_labels.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_labels.csv")

# 클러스터별 업장 분포 저장 (각 카테고리별로 별도 파일)
depth_1_df.to_csv('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_csv/cluster_depth_1_distribution.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_depth_1_distribution.csv")

depth_2_df.to_csv('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_csv/cluster_depth_2_distribution.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_depth_2_distribution.csv")

depth_3_df.to_csv('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_csv/cluster_depth_3_distribution.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_depth_3_distribution.csv")

# 클러스터별 지역 분포 저장 (각 지역별로 별도 파일)
sigungu_df.to_csv('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_csv/cluster_sigungu_distribution.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_sigungu_distribution.csv")

dong_df.to_csv('/Volumes/SAMSUMG_128/master_graduate/KCD_source_code_from_Yang/26-1/260121/result_csv/cluster_dong_distribution.csv', index=False, encoding='utf-8-sig')
