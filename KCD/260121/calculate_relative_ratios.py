...
meta_df = pd.read_csv('original_data/meta_processed.csv')
...
# 업종별 전체 대비 비율 저장
depth_1_df.to_csv('cluster_depth_1_relative_ratio.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_depth_1_relative_ratio.csv")

depth_2_df.to_csv('cluster_depth_2_relative_ratio.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_depth_2_relative_ratio.csv")

depth_3_df.to_csv('cluster_depth_3_relative_ratio.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_depth_3_relative_ratio.csv")

# 지역별 전체 대비 비율 저장
sigungu_df.to_csv('cluster_sigungu_relative_ratio.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_sigungu_relative_ratio.csv")

dong_df.to_csv('cluster_dong_relative_ratio.csv', index=False, encoding='utf-8-sig')
print("저장 완료: cluster_dong_relative_ratio.csv")
...
print("=" * 80)
print(f"\n생성된 파일:")
print("  - cluster_depth_1_relative_ratio.csv")
print("  - cluster_depth_2_relative_ratio.csv")
print("  - cluster_depth_3_relative_ratio.csv")
print("  - cluster_sigungu_relative_ratio.csv")
print("  - cluster_dong_relative_ratio.csv")
