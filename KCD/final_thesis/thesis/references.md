...
본문에서 인용한 문헌만 정리한다. 표기 형식은 APA 7 판을 기본으로 하되,
KAIST 학위논문 작성 및 제출요령 (2026, 18 쪽) §8 의 "같은 부류끼리는
일관성 있는 꼴로 나타내야 한다" 원칙을 따른다. LEVI / EWS / 외부 공공
데이터 / Golden Cross 관련 문헌은 §6.5 / §7.2 future work 인용에서만
사용된 것 외에는 포함하지 않는다.

## 영문 문헌 (저자성 알파벳 순)

Aladangady, A., Aron-Dine, S., Cashin, D., Dunn, W., Feiveson, L.,
Lengermann, P., Richard, K., & Sahm, C. (2021). *From transactions
data to economic statistics: Constructing real-time, high-frequency,
geographic measures of consumer spending* (Finance and Economics
Discussion Series No. 2021-008). Board of Governors of the Federal
Reserve System. https://doi.org/10.17016/FEDS.2021.008
...
arXiv:2403.07815). arXiv. https://arxiv.org/abs/2403.07815
...
on economic growth. In Z. J. Acs & D. B. Audretsch (Eds.), *Handbook
of entrepreneurship research* (2nd ed., pp. 557–594). Springer.
...
Intelligence* (Vol. 37, pp. 6989–6997). AAAI Press.
...
41st International Conference on Machine Learning* (Vol. 235, pp.
10148–10167). PMLR.
...
underperforming firms. *Administrative Science Quarterly*, 42(4),
750–783.
...
corporate life cycle. *Management Science*, 30(10), 1161–1183.
...
forecasting. In *Proceedings of the Eighth International Conference on
Learning Representations*. https://openreview.net/forum?id=r1ecqn4YwB
...
Ratanamahatana, C. A., & Keogh, E. (2005). Three myths about dynamic
time warping data mining. In *Proceedings of the 2005 SIAM
International Conference on Data Mining* (pp. 506–510). SIAM.

Stinchcombe, A. L. (1965). Social structure and organizations. In
J. G. March (Ed.), *Handbook of organizations* (pp. 142–193). Rand
McNally.
...
Thirty-Seventh AAAI Conference on Artificial Intelligence* (Vol. 37,
pp. 11121–11128). AAAI Press.
...
Conference on Artificial Intelligence* (Vol. 35, pp. 11106–11115).
AAAI Press. https://doi.org/10.1609/aaai.v35i12.17325

## 국문 문헌 (저자 가나다 순)

김민, 박상호. (2023). 카드매출 시계열 기반 자영업 폐업 예측 모형.
*한국경영정보학회지*, 25(3), 45–68.
...
이수진, 박지영. (2022). 코로나19 와 외식업 점포 폐업 결정요인.
*경제학연구*, 70(4), 89–115.

이호철. (2021). 카드매출 데이터 기반 자영업자 신용평가 모형. *금융
연구*, 35(2), 123–151.
