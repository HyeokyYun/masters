# 260320_codex — 개별미팅(2026-03-20) 후속 분석
...
```bash
./.venv/bin/python 260320_codex/run_all.py
```
...
- 기본 입력 CSV는 `260301/01_verify_data/outputs/tables/df_for_multinomial_logit.csv` 를 우선 사용
- 해당 파일이 없으면 기존 `260301/outputs/...`, `260225/outputs/...` 순으로 폴백
